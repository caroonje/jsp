    ...
    <div class="col-4 mx-auto" >
      <form action="InsertProcess02.jsp" method="post">
        <div class="my-3">
          ...
          <input type="text" class="form-control" id="user-id" name="userId" placeholder="사용할 UserID를 입력하세요">
        </div>
        <div class="my-3">
        ...
        <div class="my-3">
          ...
          <input type="text" class="form-control" id="user-name" name="userName" placeholder="사용할 사용자의 이름의 입력하세요">
        </div>
